...
<body>
	...
	<div>
		...
		<sec:authorize access="(isAuthenticated() and principal.username == #dto.memberid) or hasRole('ROLE_ADMIN')">
			<button type="button"
				onclick="location.href='/board/edit.do?seq=${dto.seq}&memberid=${dto.memberid}';">수정하기</button>
			<button type="button"
				onclick="location.href='/board/del.do?seq=${dto.seq}&memberid=${dto.memberid}';">삭제하기</button>
		</sec:authorize>
	</div>
